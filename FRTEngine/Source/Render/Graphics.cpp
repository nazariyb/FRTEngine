...
namespace frt
{
    ...
    void Graphics::Update()
    {
        ...
        if (_fenceValues[_currentFrameResourceIndex] != 0 && _fenceValues[_currentFrameResourceIndex] >
            lastCompletedFence)
        {
    ...
    void Graphics::BeforeFirstTick()
    {
        ...
        // Create the texture.
        {
...

            {
                ...
                // Upload texture data to the default heap resources.
                {
                    ...
                    const UINT64 uploadBufferStep =
                        GetRequiredIntermediateSize(_textures[0].Get(), 0, subresourceCount);
                    // All of our textures are the same size in this case.
                    ...
                    for (int i = 0; i < MaterialCount; ++i)
                    {
                        ...
                        auto bar_ = CD3DX12_RESOURCE_BARRIER::Transition(
                            _textures[i].Get(), D3D12_RESOURCE_STATE_COPY_DEST,
                            D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE);
                        UpdateSubresources(_commandList.Get(), _textures[i].Get(), materialsUploadHeap.Get(),
                                           i * uploadBufferStep, 0, subresourceCount, &textureData);
            ...
            CD3DX12_CPU_DESCRIPTOR_HANDLE srvHandle(_cbvSrvHeap->GetCPUDescriptorHandleForHeapStart(), 0,
        ...
        // Create the depth stencil view.
        {
            ...
            _device->CreateDepthStencilView(_depthStencil.Get(), &depthStencilDesc,
    ...
    void Graphics::LoadAssets()
    {
        ...
        // Create the root signature.
        {
            ...
            ranges[0].Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1 + MaterialCount, 0, 0,
            ...
            THROW_IF_FAILED(
                _device->CreateRootSignature(0, signature->GetBufferPointer(), signature->GetBufferSize(), IID_PPV_ARGS(
                    &_rootSignature)));
        ...
        THROW_IF_FAILED(
            _device->CreateCommandList(0, D3D12_COMMAND_LIST_TYPE_DIRECT, _commandAllocator.Get(), nullptr, IID_PPV_ARGS
                (&_commandList)));
    ...
    void Graphics::PopulateCommandList()
    {
        ...
        THROW_IF_FAILED(
            _commandList->Reset(_commandAllocators[_currentFrameResourceIndex].Get(), _pipelineStates[0].Get()));
        ...
        auto bar3 = CD3DX12_RESOURCE_BARRIER::Transition(_renderTargets[_frameIndex].Get(),
                                                         D3D12_RESOURCE_STATE_PRESENT,
                                                         D3D12_RESOURCE_STATE_RENDER_TARGET);
        _commandList->ResourceBarrier(1, &bar3);

        CD3DX12_CPU_DESCRIPTOR_HANDLE rtvHandle(_rtvHeap->GetCPUDescriptorHandleForHeapStart(), _frameIndex,
                                                _rtvDescriptorSize);
