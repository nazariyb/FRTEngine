...
float4 main(PSInput input) : SV_TARGET
{
    ...
    float4 litColor = ambient + light * 2;
...
// #pragma endregion waves
    ...
    // return distToLight / 100;
    // return float4(dirToL.xyz, 1.0f);
    // return saturate(diffuse + input.ambient + specular) * float4(0.07f, 0.07f, 0.12f, 1.0f);
}
